...
JVPSIIGrowth<-SolFitsAllPigmentfitPhycoChlalinear %>% 
  ...
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), show.legend = F, colour = "blue", size = 0.7, PC21, linetype = "dashed") +  
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), show.legend = F, colour = "blue", size = 0.7, PC0, linetype = "solid") +  
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), show.legend = F, colour = "blue", size = 0.7, PE21, linetype = "dashed") +  
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), show.legend = F, colour = "blue", size = 0.7, PE0, linetype = "solid") +  
