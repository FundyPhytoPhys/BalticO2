...
data_text_PC2<- data.frame(Strain  = c("PC-rich"), label = c('bA'))
data_text_PE1<- data.frame(Strain  = c("PE-rich"), label = c('cA'))
...
JVPSIIGrowth<-SolFitsAllPigmentfitPhycoChlalinear %>% 
  ...
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), show.legend = F, colour = "blue", size = 0.7, PC21, linetype = "dotted") +  
  ...
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), show.legend = F, colour = "blue", size = 0.7, PE21, linetype = "dotted") +  
