...
```{r read ProcessFile}
GrowthRateFile <- "../Data/ProcessedData/ProcessedGrowthRateData/BalticO2_Processed_GrowthRatePUR.Rds"
...
GrowthRate %>%
  ...
  filter(WL != "WW") %>%
  ggplot() +
  geom_point(aes(x = WLNum, y = deltaOD_Lmu_corr, colour = as.factor(Strain)), size = 4, show.legend = F) +
  geom_line(aes(x = WLNum, y = deltaOD_Lmu_corr, linetype = as.factor(O2)), show.legend = T) +
  # geom_errorbar(aes(x = WLNum, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se, colour = as.factor(Strain)), width=0, size=0.3, show.legend = F) +
...
# Already contain data from corresponding Par_ue and Ex_WL

```{r read ProcessFile}
SolisenseFile <- "../Data/ProcessedData/ProcessedSolisenseData/BalticO2_Processed_SolisenseJVPSIICorr.Rds"

#"../Data/ProcessedData/ProcessedSolisenseData/BalticO2_Processed_SolisenseData.Rds"
...
colnames(Solisense)
Solisense<-Solisense %>%
  select(-c(meanCellmL_MDPico, sdCellmL_MDPico, MC, Tube, LightShape, ExpEndDate, data, lrcplatt_Model, estimate_a, estimate_b, estimate_Pmax, std.error_a, std.error_b, std.error_Pmax)) %>% 
  unique()
```
...
GrowthRateSol <- GrowthRate %>% 
  full_join(., Solisense, by = c("Strain"="Strain", "Par_ue"="Par_ue","Photoperiod"="Photoperiod",  "O2"="O2", "WL"="WL", "PARPhotonDose_day"="PARPhotonDose_day", "Oxygen"="Oxygen", "SampleID"="SampleID", "Run"="Run", "ExpDate"="ExpDate")) %>% 
    unique()
```
...
GrowthRateSol %>%
    ...
    filter(WL != 730) %>%
  ggplot() +
  geom_point(aes(x = JVPSII_umol_eLs_Par_ue, y = deltaOD_Lmu_corr, colour = as.factor(Strain), shape = as.factor(Strain)),  alpha = 0.8, size = 3, show.legend = T) +
  geom_line(aes(x = JVPSII_umol_eLs_Par_ue, y = deltaOD_Lmu_corr, colour = as.factor(Strain), linetype = as.factor(Strain)),  alpha = 0.8, show.legend = F) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSol %>%
    ...
    filter(WL != 730) %>%
  ggplot() +
  geom_point(aes(x = JVPSII_umol_eLs_Par_ue, y = deltaOD_Lmu_corr, colour = as.factor(Strain)),  alpha = 0.8, size = 3, show.legend = F) +
  geom_line(aes(x = JVPSII_umol_eLs_Par_ue, y = deltaOD_Lmu_corr, linetype = as.factor(O2)),  alpha = 0.8,  show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab2) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab2) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab2) +
  ggh4x::facet_nested(rows = vars(Strain), labeller = label_parsed) +
...
GrowthRateSol %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_ugChl, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSol %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_umolChl, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSol %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_cell, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_ugChl_day, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSoliExpDay %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_HalfPar_ue_ugChl_day, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSoliExpDay %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSoliExpDay %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_HalfPar_ue_umolChl_day, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSoliExpDay %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_cell_day, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
GrowthRateSoliExpDay %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_HalfPar_ue_cell_day, deltaOD_Lmu_corr, colour=as.factor(Strain)), alpha = 0.9, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
```
#Cleaning the df
JVPSII_umol_eLs_HalfPar_ue_umolChl_day, JVPSII_umol_eLs_HalfPar_ue_cell_day, JVPSII_umol_eLs_HalfPar_ue_ugChl_day
```{r}
#colnames(GrowthRateSoliExpDay)

GrowthRateSoliExpDay2<-GrowthRateSoliExpDay %>% 
  select(-c(Tube, MC, LightShape, meanPURPARRatio, sdPURPARRatio, JVPSII_umol_eLs_HalfPar_ue, JVPSII_umol_eLs_Par_ue, JVPSII_umol_eLs_Par_ue_ugChl, JVPSII_umol_eLs_Par_ue_umolChl, JVPSII_umol_eLs_Par_ue_cell, JVPSII_umol_eLs_HalfPar_ue_ugChl, JVPSII_umol_eLs_HalfPar_ue_umolChl, JVPSII_umol_eLs_HalfPar_ue_cell, JVPSII_umol_eLs_HalfPar_ue_ugChl, JVPSII_umol_eLs_HalfPar_ue_umolChl, JVPSII_umol_eLs_HalfPar_ue_cell)) %>% 
  unique()
```
...
MCGrowthJVPSIISPmean<-GrowthRateSoliExpDay2 %>% 
  ...
  # select(c(Strain, Par_ue, Photoperiod, O2, Oxygen, WL, Ex_WL, deltaOD_Lmu_se, deltaOD_Lmu_corr, JVPSII_umol_eLs_Par_ue_ugChl_day, JVPSII_umol_eLs_HalfPar_ue_ugChl_day, JVPSII_umol_eLs_Par_ue_umolChl_day, JVPSII_umol_eLs_HalfPar_ue_umolChl_day, JVPSII_umol_eLs_Par_ue_cell_day, JVPSII_umol_eLs_HalfPar_ue_cell_day)) %>% 
...
MCGrowthJVPSIISPmean %>%
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_cell_day, deltaOD_Lmu_corr, colour = as.factor(Strain)), alpha = 0.8, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_cell_day, deltaOD_Lmu_corr, colour = as.factor(Strain)), alpha = 0.8, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_ugChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain)), alpha = 0.8, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_ugChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain)), alpha = 0.8, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(JVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain)), alpha = 0.8, size = 3.5, show.legend = T) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
  ggh4x::facet_nested(cols = vars(WL),rows = vars(factor(Oxygen, levels=c("250~µM","2.5~µM"))), labeller = label_parsed) +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Ex_WL), shape = as.factor(O2)), alpha = 0.8, size = 3.5, show.legend = T) +
    geom_smooth(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(O2)), alpha = 0.2, size = 1, method = "lm") +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(y=meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, x=Ex_WL, colour = as.factor(Ex_WL), shape = as.factor(O2)), alpha = 0.8, size = 3.5, show.legend = T) +
    geom_smooth(aes(y=meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, x=Ex_WL, colour = as.factor(O2)), alpha = 0.2, size = 1, method = "lm") +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain), shape = as.factor(O2)), alpha = 0.8, size = 3.5, show.legend = T) +
    geom_smooth(aes(meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.2, size = 1, method = "lm") +
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_HalfPar_ue_cell_day, deltaOD_Lmu_corr, colour = as.factor(Strain), shape = as.factor(O2)), alpha = 0.8, size = 3.5, show.legend = T) +
    geom_smooth(aes(meanJVPSII_umol_eLs_HalfPar_ue_cell_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.2, size = 1, method = "lm") +
...
data_text_PC1<- data.frame(Strain  = c("PC-rich"), label = c('a'))
data_text_PC2<- data.frame(Strain  = c("PC-rich"), label = c('b'))
data_text_PE1<- data.frame(Strain  = c("PE-rich"), label = c('b'))
data_text_PE2<- data.frame(Strain  = c("PE-rich"), label = c('bc'))
...
MultiCultiGrowth1PC21<-MCGrowthJVPSIISPmean %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 21)
MultiCultiGrowth1PE21<-MCGrowthJVPSIISPmean %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  filter(Strain == "PE-rich") %>% 
    filter(O2 == 21)
  
MultiCultiGrowth1PC0<-MCGrowthJVPSIISPmean %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 0)
MultiCultiGrowth1PE0<-MCGrowthJVPSIISPmean %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  filter(Strain == "PE-rich") %>% 
    filter(O2 == 0)
...
MCGrowthJVPSIISPmean %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, deltaOD_Lmu_corr, shape = as.factor(O2), shape = as.factor(O2)), alpha = 0.8, size = 4, show.legend = T) +
  # geom_smooth(aes(meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.2, size = 1, method = "lm", show.legend = F) +
  geom_smooth(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = deltaOD_Lmu_corr, linetype = as.factor(O2)), size = 0.7, colour = "blue", show.legend = F, alpha = 0, method = "lm") +
  
  geom_point(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "palegreen3", shape = 1, size = 4, show.legend = F, MultiCultiGrowth1PC21) +
  geom_point(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "brown4", shape = 1, size = 4, show.legend = F, MultiCultiGrowth1PE21) +
  geom_point(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "palegreen3", shape = 16, size = 4, show.legend = F, MultiCultiGrowth1PC0) +
  geom_point(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "brown4", shape = 16, size = 4, show.legend = F, MultiCultiGrowth1PE0) +
  
  geom_text(data=data_text_PC1, aes(x=2000, y=0.2, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_PC2, aes(x=4100, y=0.15, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_PE1, aes(x=2000, y=0.2, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_PE2, aes(x=6200, y=0.2, label=label), colour = "blue", size=5) +
  
  geom_text(data=data_text_Anova, aes(x=5500, y=0, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_Anova2, aes(x=4600, y=0, label=label), colour = "blue", size=5, parse = TRUE) +
  
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 1), name="", labels = lab2) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab2) +
  labs(y = "µ " ~ "("~d^-1~")", x = ""~italic(JV)~""["PSII"]*" (µmol"~e^-~""~µmol~Chl~italic(a)~""^-1~""~d^-1~")") +
...
```{r save plot}
# ggsave(file = file.path(FigPath, paste("Fig_GrowthRateJVPSII",".png",sep = "")), height=5, width= 6,  dpi = 300, limitsize = TRUE)
```
...
# StartingPoints <- read_sheet("https://docs.google.com/spreadsheets/d/1AnP4JXwSJx50ARBiyuG9B3TyxuBNR1zH-CF0FSMtFc8/edit?gid=0#gid=0") 
# 
# Dummy <- MCGrowthJVPSIISPmean %>%  
#   select(c(Strain, deltaOD_Lmu_corr, JVPSII_umol_eLs_HalfPar_ue_umolChl_day, meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, O2, WL))   
# 
# 
# MCGrowthJVPSIISPmeanDummy<-rbind(Dummy, StartingPoints)
# 
# rm(Dummy, StartingPoints)
```


```{r}
# SolFitsAllPigmentfitPhycoChlalinear <- MCGrowthJVPSIISPmeanDummy %>%   
#   #drop_na(Par_ue, Ex_WL, Phase, meanSig_nm2psii, AllmeanPhycoChlaRatio) %>% 
#   select(c(Strain, deltaOD_Lmu_corr, JVPSII_umol_eLs_HalfPar_ue_umolChl_day, meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, O2, WL)) %>%  
#   nest(data = -c("O2", "Strain")) %>%   
#   mutate(Linear_Model = map(data, ~lm(deltaOD_Lmu_corr ~ JVPSII_umol_eLs_HalfPar_ue_umolChl_day, data = .x))) %>%     
...
```{r}
SolFitsAllPigmentfitPhycoChlalinear <- MCGrowthJVPSIISPmean %>%   
  #drop_na(Par_ue, Ex_WL, Phase, meanSig_nm2psii, AllmeanPhycoChlaRatio) %>% 
  select(c(Strain, deltaOD_Lmu_corr, meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, O2, WL)) %>%  
  nest(data = -c("O2", "Strain")) %>%   
  mutate(Linear_Model = map(data, ~lm(deltaOD_Lmu_corr ~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, data = .x))) %>%     
  mutate(Linear_Model_Param = map(Linear_Model, tidy),          
         Linear_Model_Predict = map(Linear_Model, possibly(augment)),          
         Linear_Model_Glance = map(Linear_Model, possibly(glance)))
```
...
MCGrowthJVPSIISPmean %>% 
  ggplot() +
  geom_point(aes(y = deltaOD_Lmu_corr, x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, colour=as.factor(Strain)), size = 3.5, show.legend = T) +
  geom_smooth(aes(y = deltaOD_Lmu_corr, x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, linetype=as.factor(O2)), size = 1, show.legend = T, method = "lm") +
...
SolFitsAllPigmentfitPhycoChlalinear %>% 
  ...
  ggplot() +
  geom_point(aes(y = deltaOD_Lmu_corr, x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, colour=as.factor(Strain)), size = 3.5, show.legend = T, MCGrowthJVPSIISPmean) + 
  #geom_point(aes(y = deltaOD_Lmu_corr, x = JVPSII_umol_eLs_HalfPar_ue_umolChl_day, colour=as.factor(Strain)), size = 2, show.legend = T, alpha = 0.3, MCGrowthJVPSIISPmean) + 
  
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), show.legend = F) +  
  
  scale_x_continuous(breaks=seq(0, 8000, by = 2000), expand = c(0, 0)) +
...
```{r}
GrowthJVPSIIPE21<-MCGrowthJVPSIISPmean %>% 
  filter(Strain == "PE-rich") %>% 
  filter(O2 == 21)
PE21lm<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, data=GrowthJVPSIIPE21)
GrowthJVPSIIPE21lm<-summary(PE21lm)
# Coefficients:
#                                             Estimate Std. Error t value Pr(>|t|)    
# meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day 2.177e-05  2.859e-06   7.616 1.57e-06 ***


GrowthJVPSIIPE0<-MCGrowthJVPSIISPmean %>% 
  filter(Strain == "PE-rich") %>% 
  filter(O2 == 0)
PE0lm<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, data=GrowthJVPSIIPE0)
GrowthJVPSIIPE0lm<-summary(PE0lm)
# Coefficients:
#                                             Estimate Std. Error t value Pr(>|t|)   
# meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day 8.671e-05  1.781e-05   4.868   0.0046 **


GrowthJVPSIIPC21<-MCGrowthJVPSIISPmean %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 21)
PC21lm<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, data=GrowthJVPSIIPC21)
GrowthJVPSIIPC21lm<-summary(PC21lm)
# Coefficients:
#                                             Estimate Std. Error t value Pr(>|t|)   
# meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day 5.628e-05  8.793e-06   6.401  0.00138 **


GrowthJVPSIIPC0<-MCGrowthJVPSIISPmean %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 0)
PC0lm<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, data=GrowthJVPSIIPC0)
GrowthJVPSIIPC0lm<-summary(PC0lm)
# Coefficients:
#                                             Estimate Std. Error t value Pr(>|t|)    
# meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day 2.863e-05  5.486e-06   5.218 0.000287 ***
...
```{r}
# MCGrowthJVPSIISPmeanStrainPE<-MCGrowthJVPSIISPmean %>% 
#   filter(Strain == "PE-rich")
# cmodO2PErich<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day*factor(O2), data=MCGrowthJVPSIISPmeanStrainPE)
# AnovaO2PErich<-summary(cmodO2PErich)
# 
# 
# MCGrowthJVPSIISPmeanStrainPC<-MCGrowthJVPSIISPmean %>% 
#   filter(Strain == "PC-rich")
# cmodO2PCrich<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day*factor(O2), data=MCGrowthJVPSIISPmeanStrainPC)
# AnovaO2PCrich<-summary(cmodO2PCrich)
# 
# 
# MCGrowthJVPSIISPmeanOxygen21<-MCGrowthJVPSIISPmean %>% 
#   filter(O2 == 21)
# cmodStrain21<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day*factor(Strain), data=MCGrowthJVPSIISPmeanOxygen21)
# AnovaStrain21<-summary(cmodStrain21)
# 
# 
# MCGrowthJVPSIISPmeanOxygen0<-MCGrowthJVPSIISPmean %>% 
#   filter(O2 == 0)
# cmodStrain0<-lm(deltaOD_Lmu_corr~ 0 + meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day*factor(Strain), data=MCGrowthJVPSIISPmeanOxygen0)
# AnovaStrain0<-summary(cmodStrain0)
...
```{r}
# Strain across O2
Stats77_ExpSt<-MCGrowthJVPSIISPmean %>%
  filter(Strain == "PC-rich") 
  fit <- lm(deltaOD_Lmu_corr ~ 0 + JVPSII_umol_eLs_HalfPar_ue_umolChl_day + O2 + JVPSII_umol_eLs_HalfPar_ue_umolChl_day:O2,data=Stats77_ExpSt)
x <- cbind(t(as.numeric(coefficients(fit))), t(as.numeric(summary(fit)$coefficients[3, 4])), t(as.numeric(summary(fit)$coefficients[3, 3])), t(as.numeric(summary(fit)$coefficients[3, 2])))
model_77021<-data.frame(unclass(x), check.names = FALSE, stringsAsFactors = FALSE) %>% 
  rename("Estimate" = "1", "Std.Error" = "3", "t_value" = "5", "p_value" = "6") %>% 
  select(c("Estimate", "Std.Error", "t_value", "p_value"))
  model_77021$FitComparison <- 'PC-rich_0:21'


Stats127_ExpSt<-MCGrowthJVPSIISPmean %>%
  filter(Strain == "PE-rich") 
  fit <- lm(deltaOD_Lmu_corr ~ 0 + JVPSII_umol_eLs_HalfPar_ue_umolChl_day + O2 + JVPSII_umol_eLs_HalfPar_ue_umolChl_day:O2,data=Stats127_ExpSt)
x <- cbind(t(as.numeric(coefficients(fit))), t(as.numeric(summary(fit)$coefficients[3, 4])), t(as.numeric(summary(fit)$coefficients[3, 3])), t(as.numeric(summary(fit)$coefficients[3, 2])))
...
Stats77_ExpSt<-MCGrowthJVPSIISPmean %>%
  filter(O2 == 0) 
  fit <- lm(deltaOD_Lmu_corr ~ 0 + JVPSII_umol_eLs_HalfPar_ue_umolChl_day + Strain + JVPSII_umol_eLs_HalfPar_ue_umolChl_day:Strain,data=Stats77_ExpSt)
x <- cbind(t(as.numeric(coefficients(fit))), t(as.numeric(summary(fit)$coefficients[3, 4])), t(as.numeric(summary(fit)$coefficients[3, 3])), t(as.numeric(summary(fit)$coefficients[3, 2])))
...
Stats127_ExpSt<-MCGrowthJVPSIISPmean %>%
  filter(O2 == 21) 
  fit <- lm(deltaOD_Lmu_corr ~ 0 + JVPSII_umol_eLs_HalfPar_ue_umolChl_day + Strain + JVPSII_umol_eLs_HalfPar_ue_umolChl_day:Strain,data=Stats127_ExpSt)
x <- cbind(t(as.numeric(coefficients(fit))), t(as.numeric(summary(fit)$coefficients[3, 4])), t(as.numeric(summary(fit)$coefficients[3, 3])), t(as.numeric(summary(fit)$coefficients[3, 2])))
...
# Merge statistic
```{r}
Anova_GrowthJVPSII<-rbind(modelO2, modelStrain)
...
```{r}
saveRDS(Anova_GrowthJVPSII, file.path(TableRdsPath, paste(Project, "Anova_GrowthJVPSII_Model2.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
```
...
# Final plot (depend on stats)

```{r}
SolFitsAllPigmentfitPhycoChlalinearUnnest<-SolFitsAllPigmentfitPhycoChlalinear %>% 
  unnest(Linear_Model_Predict) 


PC21<-SolFitsAllPigmentfitPhycoChlalinearUnnest %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 21)
PE21<-SolFitsAllPigmentfitPhycoChlalinearUnnest %>% 
  filter(Strain == "PE-rich") %>% 
    filter(O2 == 21)
PC0<-SolFitsAllPigmentfitPhycoChlalinearUnnest %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 0)
PE0<-SolFitsAllPigmentfitPhycoChlalinearUnnest %>% 
  filter(Strain == "PE-rich") %>% 
    filter(O2 == 0)
...
data_text_PC1<- data.frame(Strain  = c("PC-rich"), label = c('aA'))
data_text_PC2<- data.frame(Strain  = c("PC-rich"), label = c('bB'))
data_text_PE1<- data.frame(Strain  = c("PE-rich"), label = c('cB'))
data_text_PE2<- data.frame(Strain  = c("PE-rich"), label = c('dA'))

data_text_Anova<- data.frame(Strain  = c("PE-rich"),  label = c('  , \u03B1 = 0.05'))
data_text_Anova2<- data.frame(Strain  = c("PE-rich"),  label = c('italic(t)~-test'))
data_text_B<- data.frame(Strain  = c("PC-rich"),  label = c('italic(b)'))
...
JVPSIIGrowth<-SolFitsAllPigmentfitPhycoChlalinear %>% 
  unnest(Linear_Model_Predict) %>% 
  ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, deltaOD_Lmu_corr, shape = as.factor(O2), shape = as.factor(O2)), alpha = 0.8, size = 4, show.legend = F, MCGrowthJVPSIISPmean) +
  # geom_point(aes(y = deltaOD_Lmu_corr, x = JVPSII_umol_eLs_HalfPar_ue_umolChl_day, colour = as.factor(Strain), shape=as.factor(O2)), size = 2, show.legend = F, alpha = 0.3, MCGrowthJVPSIISPmean) + 
  ...
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), size = 0.3, show.legend = F, colour = "blue", size = 0.7, PC21, linetype = "dashed") +  
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), size = 0.3, show.legend = F, colour = "blue", size = 0.7, PC0, linetype = "solid") +  
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), size = 0.3, show.legend = F, colour = "blue", size = 0.7, PE21, linetype = "dashed") +  
  geom_line(aes(x = meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, y = `.fitted`), size = 0.3, show.legend = F, colour = "blue", size = 0.7, PE0, linetype = "solid") +  
  
  geom_text(data=data_text_PC1, aes(x=2000, y=0.15, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_PC2, aes(x=4100, y=0.14, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_PE1, aes(x=1700, y=0.18, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_PE2, aes(x=6200, y=0.15, label=label), colour = "blue", size=5) +
  
  geom_text(data=data_text_Anova, aes(x=5700, y=0, label=label), colour = "blue", size=5) +
  geom_text(data=data_text_Anova2, aes(x=4600, y=0, label=label), colour = "blue", size=5, parse = TRUE) +
  
  geom_text(data=data_text_B, aes(x=7600, y=0.18, label=label), size=6, parse = TRUE) +
  
  scale_x_continuous(breaks=seq(0, 8000, by = 2000), expand = c(0, 0)) +
  scale_y_continuous(breaks=seq(0, 0.2, by = 0.05)) +
  coord_cartesian(xlim = c(0, 8000), ylim = c(-0.01, 0.2)) +
...
```{r save plot}
#ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_ChlaCorr",".png",sep = "")), height=5.5, width= 6,  dpi = 300, limitsize = TRUE)
```
...
```{r read ProcessFile}
SolisenseFile <- "../Data/ProcessedData/ProcessedSolisenseData/BalticO2_Processed_SolisenseJVPSII445590.Rds"
...
```{r Joining growth rate and Solisense exp data}
GrowthRateSol445590 <- GrowthRate %>% 
  full_join(., Solisense, by = c("Strain"="Strain", "Par_ue"="Par_ue","Photoperiod"="Photoperiod",  "O2"="O2", "WL"="WL", "PARPhotonDose_day"="PARPhotonDose_day", "Oxygen"="Oxygen", "SampleID"="SampleID", "Run"="Run", "ExpDate"="ExpDate")) %>% 
    unique()
```
...
```{r}
GrowthRateSol445590<-GrowthRateSol445590 %>%
  mutate(meanTurChl_umolL=meanTurChl_ugL*0.00112)
```
...
GrowthRateSoliExpDay445590<-GrowthRateSol445590 %>% 
  mutate(JVPSII_umol_eLs_Par_ue_ugChl_day = JVPSII_umol_eLs_Par_ue_ugChl*3600*Photoperiod/2) %>%
  mutate(JVPSII_umol_eLs_HalfPar_ue_ugChl_day = JVPSII_umol_eLs_HalfPar_ue_ugChl*3600*Photoperiod/2) %>%
  mutate(JVPSII_umol_eLs_Par_ue_umolChl_day = JVPSII_umol_eLs_Par_ue_umolChl*3600*Photoperiod/2) %>% 
  mutate(JVPSII_umol_eLs_HalfPar_ue_umolChl_day = JVPSII_umol_eLs_HalfPar_ue_umolChl*3600*Photoperiod/2) %>% 
...
GrowthRateSoliExpDay445590<-GrowthRateSoliExpDay445590 %>% 
  select(-c(Tube, MC, LightShape, meanPURPARRatio, sdPURPARRatio, JVPSII_umol_eLs_HalfPar_ue, JVPSII_umol_eLs_Par_ue, JVPSII_umol_eLs_Par_ue_ugChl, JVPSII_umol_eLs_Par_ue_umolChl, JVPSII_umol_eLs_Par_ue_cell, JVPSII_umol_eLs_HalfPar_ue_ugChl, JVPSII_umol_eLs_HalfPar_ue_umolChl, JVPSII_umol_eLs_HalfPar_ue_cell, JVPSII_umol_eLs_HalfPar_ue_ugChl, JVPSII_umol_eLs_HalfPar_ue_umolChl, JVPSII_umol_eLs_HalfPar_ue_cell, JVPSII_umol_eLs_HalfPar_ue_ugChl_day, JVPSII_umol_eLs_HalfPar_ue_umolChl_day, JVPSII_umol_eLs_HalfPar_ue_cell_day)) %>% 
  unique()
```
...
MCGrowthJVPSIISPmean445590<-GrowthRateSoliExpDay445590 %>% 
  # drop_na(JVPSII_umol_eLs_Par_ue_ugChl_day) %>%
  # drop_na(JVPSII_umol_eLs_Par_ue_cell_day) %>%
  # select(c(Strain, Par_ue, Photoperiod, O2, Oxygen, WL, Ex_WL, deltaOD_Lmu_se, deltaOD_Lmu_corr, JVPSII_umol_eLs_Par_ue_ugChl_day, JVPSII_umol_eLs_HalfPar_ue_ugChl_day, JVPSII_umol_eLs_Par_ue_umolChl_day, JVPSII_umol_eLs_HalfPar_ue_umolChl_day, JVPSII_umol_eLs_Par_ue_cell_day, JVPSII_umol_eLs_HalfPar_ue_cell_day)) %>% 
  
  group_by(Strain, O2, WL, Ex_WL) %>%
  summarize(Strain, Par_ue, Photoperiod, O2, Oxygen, WL, Ex_WL, deltaOD_Lmu_se, deltaOD_Lmu_corr, JVPSII_umol_eLs_Par_ue_ugChl_day, JVPSII_umol_eLs_Par_ue_umolChl_day, JVPSII_umol_eLs_Par_ue_cell_day, 
...
MCGrowthJVPSIISPmean445590$facetsStrain <- 'Strain'
```
...
MCGrowthJVPSIISPmean445590 %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain)), alpha = 0.8, size = 3.5, show.legend = T) +
  geom_line(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain), linetype = as.factor(Strain)), alpha = 0.8, show.legend = F) +
  
  geom_errorbar(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se, colour = as.factor(Strain)), width=0, size=0.3, show.legend = F) +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab1) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab1) +
...
MCGrowthJVPSIISPmean445590 %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain), shape = as.factor(WL)), alpha = 0.8, size = 3.5, show.legend = T) +
  geom_line(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.8, show.legend = T) +
...
MCGrowthJVPSIISPmean445590 %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(WL), shape = as.factor(O2)), alpha = 0.8, size = 3.5, show.legend = T) +
  geom_line(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.8, show.legend = T) +
  
  geom_errorbar(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se), width=0, size=0.3, show.legend = F) +
  #scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab2) +
...
MultiCultiGrowth1PC21<-MCGrowthJVPSIISPmean445590 %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  ...
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 21)
MultiCultiGrowth1PE21<-MCGrowthJVPSIISPmean445590 %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  filter(WL == 450 | WL == 620 | WL == 530) %>%
  filter(Ex_WL == 590 | Ex_WL == 445 | Ex_WL == 535) %>%
...
MultiCultiGrowth1PC0<-MCGrowthJVPSIISPmean445590 %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  filter(WL == 450 | WL == 620 | WL == 530) %>%
  filter(Ex_WL == 590 | Ex_WL == 445 | Ex_WL == 535) %>%
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 0)
MultiCultiGrowth1PE0<-MCGrowthJVPSIISPmean445590 %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  filter(WL == 450 | WL == 620 | WL == 530) %>%
  filter(Ex_WL == 590 | Ex_WL == 445 | Ex_WL == 535) %>%
...
MCGrowthJVPSIISPmean445590 %>% 
  ...
  filter(Ex_WL == 590 | Ex_WL == 445 | Ex_WL == 535) %>%
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, shape = as.factor(O2)), alpha = 0.8, size = 4, show.legend = T) +
  #geom_line(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.8, show.legend = T) +
  
    geom_point(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "palegreen3", shape = 1, size = 4, show.legend = F, MultiCultiGrowth1PC21) +
    geom_point(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "brown4", shape = 1, size = 4, show.legend = F, MultiCultiGrowth1PE21) +
    geom_point(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "palegreen3", shape = 16, size = 4, show.legend = F, MultiCultiGrowth1PC0) +
    geom_point(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = deltaOD_Lmu_corr), colour = "brown4", shape = 16, size = 4, show.legend = F, MultiCultiGrowth1PE0) +
  
  geom_errorbar(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, ymin = deltaOD_Lmu_corr - deltaOD_Lmu_se, ymax = deltaOD_Lmu_corr + deltaOD_Lmu_se, colour = as.factor(Strain)), width=0, size=0.3, show.legend = F) +
  
  # geom_errorbar(aes(y = deltaOD_Lmu_corr, xmin = meanJVPSII_umol_eLs_Par_ue_umolChl_day - sdJVPSII_umol_eLs_Par_ue_umolChl_day, xmax = meanJVPSII_umol_eLs_Par_ue_umolChl_day + sdJVPSII_umol_eLs_Par_ue_umolChl_day, colour = as.factor(Strain)), width=0, size=0.3, show.legend = F) +
...
```{r save plot}
#ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_Chla",".png",sep = "")), height=6, width= 6,  dpi = 300, limitsize = TRUE)
```
...
```{r}
MCDataHourSVR <- MCGrowthJVPSIISPmean445590 %>% 
    mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>% 
  drop_na(meanJVPSII_umol_eLs_Par_ue_umolChl_day) %>% 
  drop_na(deltaOD_Lmu_corr) %>% 
  select(c(deltaOD_Lmu_corr, meanJVPSII_umol_eLs_Par_ue_umolChl_day, Strain, O2, Oxygen, Ex_WL, WL, WLNum))


# Function to train an SVM model and make predictions
train_and_predict_svm <- function(data) {
  svr_model <- svm(deltaOD_Lmu_corr ~ meanJVPSII_umol_eLs_Par_ue_umolChl_day, data = data, kernel = 'radial',
                   cost = 5, gamma = 1)
...
MCDataHourSVR %>%
  ...
  ggplot() +
  geom_point(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = deltaOD_Lmu_corr), alpha = 0.4) +
  geom_line(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = svr_pred, color = 'SVR_radial')) +
  geom_line(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = deltaOD_Lmu_corr)) +
...
ggplot() +
  ...
  geom_line(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = svr_pred, linetype = as.factor(O2)), show.legend = T, size = 0.6, MCDataHourSVR) +
...
MCGrowthJVPSIISPmean445590 %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain), shape = as.factor(O2)), alpha = 0.8, size = 3.5, show.legend = T) +
  # geom_line(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.8, show.legend = T) +
  
  geom_line(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = deltaOD_Lmu_corr, linetype = as.factor(O2)), show.legend = T, size = 0.6) +
  #geom_line(aes(x = meanJVPSII_umol_eLs_Par_ue_umolChl_day, y = svr_pred, linetype = as.factor(O2)), show.legend = T, size = 0.6, MCDataHourSVR) +
  ...
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab2) +
  scale_x_continuous(label=scientific_10) +
  ggh4x::facet_nested(cols = vars(Ex_WL), rows = vars(Strain, O2), labeller = label_parsed) +
  theme_bw() +
  theme(panel.grid.minor = element_blank(),
        panel.grid.major = element_blank(),
        panel.spacing.x = unit(0.4, 'cm'),
...
```{r save plot}
#ggsave(file = file.path(FigPath, paste("Fig_GrowthRate_JVPSII_Chla445590_3",".png",sep = "")), height=5.5, width= 6,  dpi = 300, limitsize = TRUE)
```
...
```{r}
SolFitsMetaLightCorr445590Trim1<-MCGrowthJVPSIISPmean445590 %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 21) %>% 
  filter(WL != 405) 

SolFitsMetaLightCorr445590Trim3<-MCGrowthJVPSIISPmean445590 %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 0) 

SolFitsMetaLightCorr445590Trim4<-MCGrowthJVPSIISPmean445590 %>% 
  filter(Strain == "PE-rich") %>% 
  filter(O2 == 21) %>% 
  filter(WL != 405) %>% 
  filter(WL != 450) %>% 
...
SolFitsMetaLightCorr445590Trim5<-MCGrowthJVPSIISPmean445590 %>% 
  filter(Strain == "PE-rich") %>% 
  filter(O2 == 0) 


MCGrowthJVPSIISPmean445590Trim<-rbind(SolFitsMetaLightCorr445590Trim1, SolFitsMetaLightCorr445590Trim3, SolFitsMetaLightCorr445590Trim4, SolFitsMetaLightCorr445590Trim5)
...
MCGrowthJVPSIISPmean445590Trim %>% 
  filter(WL != "WW") %>% 
ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, colour = as.factor(Strain), shape = as.factor(O2)), alpha = 0.8, size = 3.5, show.legend = T) +
  # geom_line(aes(meanJVPSII_umol_eLs_Par_ue_umolChl_day, deltaOD_Lmu_corr, linetype = as.factor(O2)), alpha = 0.8, show.legend = T) +
