...
SolFitsAllPigmentfitPhycoChlalinear %>% 
  unnest(Linear_Model_Predict) %>% 
  ggplot() +
  geom_point(aes(meanJVPSII_umol_eLs_HalfPar_ue_umolChl_day, deltaOD_Lmu_corr, shape = as.factor(O2), shape = as.factor(O2)), alpha = 0.8, size = 4, show.legend = T, MCGrowthJVPSIISPmean) +
