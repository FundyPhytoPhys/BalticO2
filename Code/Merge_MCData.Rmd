...
#DataIn <- file.path("..", "Data","ProcessedData", "ProcessedMCDataFit")
...
```{r save files}
# saveRDS(object = MCGrowthFits, file = file.path(DataOut, paste(Project, "Cleaned_MCDataFit.Rds",  sep = "_")), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
