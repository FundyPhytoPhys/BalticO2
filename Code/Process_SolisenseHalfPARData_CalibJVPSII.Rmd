...
SolFitsMetaLRC <- SolFitsMetaLRC %>%
  ...
  summarize(SampleID, Ex_WL, FilenameSolisense, Run, Strain, ExpDate, Par_ue, Photoperiod, O2, WL, WLNum, Oxygen, PARPhotonDose_day, ObsDate, ObsTime, ObsDateTime, Sig, Sig_nm2psii, ActPARCorr, ActPARCorr_photonsm2s, Sigdark_nm2psii, FoOxbo, qpOxbo, JVPSII_umol_eLs, E_days, TauAv, qpOxbo,
...
```{r save plot}
#ggsave(file = file.path(FigPath, paste("SFig_CalibJVPSII_eLs",".png",sep = "")), height=6, width= 6,  dpi = 300, limitsize = TRUE)
```
