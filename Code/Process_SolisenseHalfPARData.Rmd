...
```{r calculated statistics}
SolFitsMetaLRCTrimChoosenStat<-SolFitsMetaLRCTrimChoosen 

#MCGrowthRateStats<-rbind(MultiCultiGrowth2, MultiCultiGrowth2) #I created double data here

SolFitsMetaLRCTrimChoosenStat$O2 <- factor(SolFitsMetaLRCTrimChoosenStat$O2)
SolFitsMetaLRCTrimChoosenStat$WL <- factor(SolFitsMetaLRCTrimChoosenStat$WL)
SolFitsMetaLRCTrimChoosenStat$Strain <- factor(SolFitsMetaLRCTrimChoosenStat$Strain)
