...
drectsemiblue <- data.frame(Ex_WL = c("470", "470"), Strain = c("PC-rich", "PE-rich"), WL = c("470", "470"), x1=c(-35), x2=c(835), y1=c(-0.5), y2=c(10.5))
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_Sig",".png",sep = "")), height=6, width= 6,  dpi = 300, limitsize = TRUE)
```
...
drectblue <- data.frame(Ex_WL = c("445", "445"), Strain = c("PC-rich", "PE-rich"), WL = c("450", "450"), x1=c(-35), x2=c(835), y1=c(-0.5), y2=c(2000))

drectsemiblue <- data.frame(Ex_WL = c("470", "470"), Strain = c("PC-rich", "PE-rich"), WL = c("470", "470"), x1=c(-35), x2=c(835), y1=c(-0.5), y2=c(2000))

drectgreen <- data.frame(Ex_WL = c("535", "535"), Strain = c("PC-rich", "PE-rich"), WL = c("530", "530"), x1=c(-35), x2=c(835), y1=c(-0.5), y2=c(2000))

drectred <- data.frame(Ex_WL = c("590", "590"), Strain = c("PC-rich", "PE-rich"), WL = c("620", "620"), x1=c(-35), x2=c(835), y1=c(-0.5), y2=c(2000))
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_Tau",".png",sep = "")), height=6, width= 6,  dpi = 300, limitsize = TRUE)
```
...
drectblue <- data.frame(Ex_WL = c("445", "445"), Strain = c("PC-rich", "PE-rich"), WL = c("450", "450"), x1=c(-35), x2=c(835), y1=c(0), y2=c(1))

drectsemiblue <- data.frame(Ex_WL = c("470", "470"), Strain = c("PC-rich", "PE-rich"), WL = c("470", "470"), x1=c(-35), x2=c(835), y1=c(0), y2=c(1))

drectgreen <- data.frame(Ex_WL = c("535", "535"), Strain = c("PC-rich", "PE-rich"), WL = c("530", "530"), x1=c(-35), x2=c(835), y1=c(0), y2=c(1))

drectred <- data.frame(Ex_WL = c("590", "590"), Strain = c("PC-rich", "PE-rich"), WL = c("620", "620"), x1=c(-35), x2=c(835), y1=c(0), y2=c(1))
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_qpOxbo",".png",sep = "")), height=6, width= 6,  dpi = 300, limitsize = TRUE)
```
