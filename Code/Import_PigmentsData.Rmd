...
ChlDataMeta %>%
  ...
  ggh4x::facet_nested(rows = vars(Par_ue, O2, E_days), cols = vars(Strain), labeller = labeller(Ex_WL = label_both, strain = label_value, Par_ue = label_both, WL = label_both, Photoperiod = label_value)) +
  theme_bw()
