...
ggplot() +
  geom_point(aes(ActPARCorr, Sig, colour = as.factor(Strain)), alpha = 0.8, size = 3.5, show.legend = T, SolFitsMeta) +
...
SolFitsMetaLRCGrowth445590<-rbind(SolFitsMetaLRCGrowthCorr1, SolFitsMetaLRCGrowthCorr2)
  rm(SolFitsMetaLRCGrowthCorr1, SolFitsMetaLRCGrowthCorr2)
