...
OLISSpectraMetaPUR %>%
  ...
  geom_area(aes(x = nm, y = PURNorm, fill = "palegreen3"), alpha = 0.5, show.legend = F, OLISSpectraMetaPUR77) +
  geom_area(aes(x = nm, y = PURNorm, fill = "brown4"), alpha = 0.5, show.legend = F, OLISSpectraMetaPUR127) +
  geom_area(aes(x = nm, y = PURNorm, fill = "brown4"), alpha = 0.5, show.legend = F, OLISSpectraMetaPUR127405) +
  # geom_area(aes(x = nm, y = PURNormBA77G, fill = "palegreen3"), alpha = 0.5, show.legend = F) +
  geom_line(aes(x = nm, y = AbsNorm440, colour = as.factor(Strain)), show.legend = T, size = 0.4) +
  geom_line(aes(x = nm, y = AbsNorm440, colour = as.factor(Strain)), show.legend = F, size = 0.4, OLISSpectraMetaPUR127405) +
  scale_color_manual(values = c("PC-rich_077" ="palegreen3", "PE-rich_127" ="brown4")) +
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("Fig_OlisSpectra",".png",sep = "")), height=5, width= 10,  dpi = 300, limitsize = TRUE)
```
...
OLISAllPURTidyChoosen<-OLISAllPURTidy %>% 
  ...
  summarize(SampleID, Run, Strain, ExpDate, Par_ue, Photoperiod, Tube, O2, WL, LightShape, PARPhotonDose_day, PUR, PURPhotonDose_day, E_days, PURPARRatio,
...
OLISAllPURTidyChoosen %>%
  ...
  geom_point(aes(x = WLNum, y = meanPURPARRatio, colour = as.factor(Strain)), size = 3, show.legend = T) +
  geom_line(aes(x = WLNum, y = meanPURPARRatio, colour = as.factor(Strain)), show.legend = F) +
