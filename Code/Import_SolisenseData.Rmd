...
```{r save rds}
# saveRDS(SolFitsTrimOS_lightsteps, file.path(DataOut, paste(Project, "Imported_SolFitsTrimOS_lightsteps.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
...
```{r save rds}
# saveRDS(SolFitsTrimMetaDarkafterLightOS, file.path(DataOut, paste(Project, "Imported_SolFitsTrimMetaDarkafterLightOS.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
