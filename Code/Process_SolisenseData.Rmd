...
SolFitsMetaLRC %>%
  ...
  geom_rect(data=drectblue, mapping=aes(xmin=x1, xmax=x2, ymin=y1, ymax=y2), fill = "transparent", color="blue", size=1) +
  geom_rect(data=drectgreen, mapping=aes(xmin=x1, xmax=x2, ymin=y1, ymax=y2), fill = "transparent", color="darkgreen", size=1) +
  geom_rect(data=drectred, mapping=aes(xmin=x1, xmax=x2, ymin=y1, ymax=y2), fill = "transparent", color="red", size=1) +
...
SolFitsMetaLightCorr445590<-rbind(SolFitsMetaLightCorr1, SolFitsMetaLightCorr2)
  rm(SolFitsMetaLightCorr1, SolFitsMetaLightCorr2)
