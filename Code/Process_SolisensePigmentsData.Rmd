...
SolisenseFile <- "../Data/ProcessedData/ProcessedSolisenseData/BalticO2_Processed_SolisenseDataCorrHalfPAR.Rds"  
...
SolisenseFile <- "../Data/ProcessedData/ProcessedSolisenseData/BalticO2_Processed_SolisenseData445590HalfPAR.Rds"
...
labWLAll=c(expression("405"), expression("450"), expression("470"), expression("530"), expression("620"), expression("660"), expression("730"))
...
SolFitsPigmentExp445590Choose %>% 
  ...
  geom_point(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, colour = as.factor(WL)), size = 4, show.legend = F) +
  geom_line(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, linetype = as.factor(O2)), show.legend = T) +
  geom_errorbar(aes(x = meanPhycoChlaRatio, ymin = meanSig_nm2psii - sdSig_nm2psii, ymax = meanSig_nm2psii + sdSig_nm2psii), width=0, size=0.3, show.legend = F) +
  scale_colour_manual(values = c("royalblue4", "steelblue3", "lightseagreen", "limegreen", "coral","brown1","indianred4"), name="", labels = labWLAll) +
  #scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab2) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab2) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab2) +
  labs(y=expression(paste(sigma,""["PSII"]*"' (nm"^"2"*" quanta"^"-1"*")")), x = "Phycobiliprotein to Chl" ~italic(a)~ "ratio (µg:µg)") +
...
labWL=c(expression("450"), expression("530"), expression("620"))
...
SolFitsPigmentExp445590Choose %>% 
  ...
  geom_point(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, colour = as.factor(WL)), size = 4, show.legend = T) +
  geom_line(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, linetype = as.factor(O2)), show.legend = T) +
  geom_errorbar(aes(x = meanPhycoChlaRatio, ymin = meanSig_nm2psii - sdSig_nm2psii, ymax = meanSig_nm2psii + sdSig_nm2psii), width=0, size=0.3, show.legend = F) +
  #scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab2) +
  scale_colour_manual(values = c("steelblue3", "limegreen", "coral"), name="", labels = labWL) +
  scale_shape_manual(values = c(16, 18), name="", labels = lab2) +
  scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab2) +
  labs(y=expression(paste(sigma,""["PSII"]*"' (nm"^"2"*" quanta"^"-1"*")")), x = "Phycobiliprotein to Chl" ~italic(a)~ "ratio (µg:µg)") +
  #labs(y = "Chlorophyll-specific exponential growth rate " ~ "("~d^-1~")", x = "Growth wavelength (nm)") +
...
SolFitsPigmentExp445590Choose %>% 
  ...
  filter(WL != "WW") %>%
  ggplot() +
  geom_point(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, colour = as.factor(Strain), shape = as.factor(O2)), size = 4, show.legend = T) +
  geom_line(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, linetype = as.factor(O2)), show.legend = T) +
  geom_errorbar(aes(x = meanPhycoChlaRatio, ymin = AllmeanSig_nm2psii - AllsdSig_nm2psii, ymax = AllmeanSig_nm2psii + AllsdSig_nm2psii), width=0, size=0.3, show.legend = F) +
  # stat_wl_strip(aes(x = WLNum), ymin = -Inf, ymax = -0.025, alpha = 0.5) +
  # scale_fill_identity() +
  scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab1) +
  scale_shape_manual(values = c(16, 1), name="", labels = lab2) +
...
```{r}
SolFitsMetaLightCorr445590Trim1<-SolFitsPigmentExp445590Choose %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 21) %>% 
  filter(WL != 405) 

SolFitsMetaLightCorr445590Trim3<-SolFitsPigmentExp445590Choose %>% 
  filter(Strain == "PC-rich") %>% 
  filter(O2 == 0) 

SolFitsMetaLightCorr445590Trim4<-SolFitsPigmentExp445590Choose %>% 
  filter(Strain == "PE-rich") %>% 
  filter(O2 == 21) %>% 
  filter(WL != 405) %>% 
  filter(WL != 450) %>% 
...
SolFitsMetaLightCorr445590Trim5<-SolFitsPigmentExp445590Choose %>% 
  filter(Strain == "PE-rich") %>% 
  filter(O2 == 0) 


SolFitsPigmentExp445590ChooseTrim<-rbind(SolFitsMetaLightCorr445590Trim1, SolFitsMetaLightCorr445590Trim3, SolFitsMetaLightCorr445590Trim4, SolFitsMetaLightCorr445590Trim5)
...
SolFitsPigmentExp445590ChooseTrim %>% 
  mutate(WLNum = if_else(WL == "WW", 750, as.numeric(WL))) %>%
  filter(WL != "WW") %>%
  ggplot() +
  geom_point(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, colour = as.factor(Strain), shape = as.factor(O2)), size = 4, show.legend = T) +
...
labWL=c(expression("450"), expression("530"), expression("620"))
labO2=c(expression("2.5"), expression("250"))
...
SolFitsPigmentExp445590ChooseTrim %>% 
  ...
  geom_point(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, colour = as.factor(WL), shape = as.factor(O2)), size = 4, show.legend = T) +
  geom_smooth(aes(x = meanPhycoChlaRatio, y = AllmeanSig_nm2psii, linetype = as.factor(O2)), show.legend = T, method = "lm") +
  # geom_errorbar(aes(x = meanPhycoChlaRatio, ymin = meanSig_nm2psii - sdSig_nm2psii, ymax = meanSig_nm2psii + sdSig_nm2psii), width=0, size=0.3, show.legend = F) +
  #scale_colour_manual(values = c("palegreen3", "brown4"), name="", labels = lab2) +
  #scale_colour_manual(values = c("steelblue3", "limegreen", "coral"), name="", labels = labWL) +
  scale_shape_manual(values = c(16, 1), name="", labels = labO2) +
  #scale_linetype_manual(values = c("solid", "dashed"), name="", labels = lab2) +
  labs(y=expression(paste(sigma,""["PSII"]*"' (nm"^"2"*" quanta"^"-1"*")")), x = "Phycobiliprotein to Chl" ~italic(a)~ "ratio (µg:µg)") +
  #labs(y = "Chlorophyll-specific exponential growth rate " ~ "("~d^-1~")", x = "Growth wavelength (nm)") +
  ggh4x::facet_nested(cols = vars(Ex_WL), rows = vars(Strain), labeller = label_parsed) +
...
# 
# 
# saveRDS(SolFitsPigmentExpChoose, file.path(DataOut, paste(Project, "Processed_SolisensePigmentsDataCorrHalfPAR.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
# 
# saveRDS(SolFitsPigmentExp445590Choose, file.path(DataOut, paste(Project, "Processed_SolisensePigmentsData445590HalfPAR.Rds", sep = "_"), fsep = .Platform$file.sep), ascii = FALSE, version = NULL, compress = "xz", refhook = NULL)
