...
OD680<-MultiCultiDataAll %>%
  ...
  geom_line(aes(x = Time_h/24, y = meanOD680_h, colour = as.factor(O2)), size = 0.8, show.legend = T) +
  #scale_colour_discrete(type=c("palegreen3", "brown4")) +
  scale_colour_discrete(type=c("dodgerblue4", "deepskyblue2"), name="", labels = lab2) +
...
OD720<-MultiCultiDataAll %>%
  ...
  geom_line(aes(x = Time_h/24, y = meanOD720_h, colour = as.factor(O2)), size = 0.5, show.legend = T) +
  #scale_colour_discrete(type=c("palegreen3", "brown4")) +
...
ODDelta<-MultiCultiDataAll %>%
  ...
  #geom_area(aes(x = Time_h, y = meanActinic_par_h), size = 0.1, fill = "tan1", alpha = 0.6) +
  geom_line(aes(x = Time_h/24, y = meanDeltaOD_h, colour = as.factor(O2)), size = 0.5, show.legend = T) +
  
  #geom_line(aes(x = time_h/24, y = meanfittedDeltaOD_h, colour = as.factor(O2)), size = 1, alpha = 0.9, show.legend = T, MCGrowthRateFitData) +
  #scale_colour_discrete(type=c("palegreen3", "brown4")) +
  #scale_colour_discrete(type=c("palegreen3", "brown4"), name="") +
