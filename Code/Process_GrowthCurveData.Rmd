...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_GrowthCurve_Delta",".png",sep = "")), height=5, width= 8,  dpi = 300, limitsize = TRUE)
```
...
```{r save plot}
ggsave(file = file.path(FigPath, paste("SFig_GrowthCurve_OD720",".png",sep = "")), height=5, width= 8,  dpi = 300, limitsize = TRUE)
```
