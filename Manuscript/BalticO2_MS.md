...
## Chlorophyll-specific growth rates across [O~2~], wavebands, and strains {.unnumbered}
...
## Pigment content and pigment ratio across [O~2~], wavebands, and strains {.unnumbered}
...
## Effective absorption cross sections, turnover times, and photochemical quenching of PSII across [O~2~], wavebands, and strains {.unnumbered}
...
## Growth rates vs. cumulative diel PSII electron flux across [O~2~], wavebands, and strains {.unnumbered}
...
Microdiversity is important in Synechococcus populations and that it could reflect extensive diversification of different pigmentation phenotypes into different ecological niches [@haverkampColorfulMicrodiversitySynechococcus2009a].
