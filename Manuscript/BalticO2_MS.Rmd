...
Chlorophyll-specific growth rates (µ; d^−1^) show positive linear responses to the Phycobiliproteins:Chlorophyll *a* ratio (µg:µg), for both PC-rich and PE-rich *Synechococcus*  (Fig. \@ref(fig:Pigment)*b*), although the relations vary across strain and [O~2~] (Tab. S11). 
