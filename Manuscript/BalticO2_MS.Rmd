...
We used logistic curve fits (Fig. Sxxx) to determine chlorophyll-specific exponential growth rates (μ; d^−1^), for PC-rich and PE-rich cultures of *Synechococcus* sp. grown at spectral bandwidth of 405, 450, 470, 530, 620, 660, and 730 nm and O~2~ concentration of 250 µM and 2.5 µM. Three-way factorial ANOVA showed that peak PAR, photoperiod, strain, and their interactions, significantly affected μ (ANOVA, *p* < 0.05 for all; Table Sxxx). 


In general, PC-rich strains achieved faster growth rates under O~2~ concentration of 250 µM across tested spectral bandwidth (nm). On the other hand, PE-rich strain showed similar growth rates under 250 µM and 2.5 µM of O~2~ concentration across tested spectral bandwidth (nm). The exception was noted for the growth rate obtained at 405 nm, where higher growth rates were achieved under 2.5 µM O~2~ than under 250 µM O~2~ for both PC-rich and PE-rich strains.

PC-rich *Synechococcus* sp. showed distinct growth peak at red light (μ = 1.17 d^−1^ at 620 nm and μ = 0.95 d^−1^ at 660 nm) under O~2~ concentration of 250 µM. PE-rich strain showed the highest growth rates under green light at 530 nm under 2.5 µM of O~2~ (μ = 0.80 d^−1^).


0.53

All tested strains, except PE-rich_048, grew even under peak PAR 900 µmol photons m^−2^s^−1^ and 24 h photoperiod. The highest growth rate was recorded for *Synechococcus* sp. PE-rich_127 (μ = 4.5 d^−1^; 3.7 h doubling time) and PC-rich_056 (μ = 3.4 d^−1^; 4.9 h doubling time) at 180 µmol photons m^−2^s^−1^ peak PAR and photoperiod of 24 h.




 For the PE-rich strains growth decreased with decreasing photoperiod and decreasing peak PAR. Moreover, PE-rich strains showed photoinhibition of growth at peak PAR of 900 µmol photons m^−2^s^−1^ and photoperiods of 16- 24 h. The growth rate contours for PC-rich and PE-rich *Synechococcus* sp. did not generally follow isoclines of cumulative diel photon dose (µmol photons m^−2^d^−1^, dashed lines), showing that photoperiod, and peak PAR influenced growth rates beyond cumulative diel photon dose.
