...
GrowthCurve_cap<- glue("**Growth curves, tracked as OD~680~ vs. elapsed time (d)**. Growth curves were estimated over 5-min intervals for  PC-rich_077 (light green) and PE-rich_127 (dark red) cultures of *Synechococcus* sp. grown at spectral bandwidth of 405, 445, 470, 535, 620, 660, and 720 nm and O~2~ concentration of 250 µM and 2.5 µM.", .sep = " ")
...
GrowthRatePhotoperiodPUR_cap<- glue("**Chlorophyll-specific exponential growth rates (d^−1^) vs. growth wavelength (nm)**. Growth rates (± SE falling within symbols) were estimated from logistic fits of chlorophyll proxy OD~680~ – OD~720~ (ΔOD) vs. elapsed time, for PC-rich_077 (light green circle; solid line) and PE-rich_127 (dark red diamond; dashed line) cultures of *Synechococcus* sp. grown at spectral bandwidth of 405, 445, 470, 535, 620, 660, and 720 nm and O~2~ concentration of 250 µM and 2.5 µM.", .sep = " ")
knitr::include_graphics(file.path(FiguresFP,"Fig_GrowthRate3.png"))
```
...
OlisSpectra_cap<- glue("(A) **Whole-cell absorbance spectra** of PC-rich_077 (solid light green lines) or PE-rich_127 (dashed dark red lines) cultures of *Synechococcus* sp. grown at spectral bandwidth of 405, 445, 470, 535, 620, 660, and 720 nm and O~2~ concentration of 250 µM and 2.5 µM. Representative absorbance spectra, normalized to 440 nm (NormA~440~), were measured together with emission spectra of the white LED lamp used for PAR, normalized to their emission peak (light gray area). Estimated Photosynthetically Usable Radiation (PUR) is shown as a green area for the PC-rich_077 strain and a red area for the PE-rich_127 strain. (B) **Changes in PUR/PAR ratio vs. growth wavelength (nm)**. PUR/PAR ratio was estimated for PC-rich_077 (light green circle; solid line) and PE-rich_127 (dark red diamond; dashed line) cultures of *Synechococcus* sp. grown at spectral bandwidth of 405, 445, 470, 535, 620, 660, and 720 nm and O~2~ concentration of 250 µM and 2.5 µM.", .sep = " ")
...
PURPARRatio_cap<- glue("**Changes in PUR/PAR ratio vs. growth wavelength (nm)**. PUR/PAR ratio was estimated for PC-rich_077 (light green circle; solid line) and PE-rich_127 (dark red diamond; dashed line) cultures of *Synechococcus* sp. grown at spectral bandwidth of 405, 445, 470, 535, 620, 660, and 720 nm and O~2~ concentration of 250 µM and 2.5 µM.", .sep = " ")
...
knitr::include_graphics(file.path( FiguresFP,"Fig_Sig2.png"))
```
...
GrowthRateJVPSII_cap<- glue("**Uncalibrated PSII electron flux  measured under diel peak PAR growth light vs. wavelength (nm)**. *JV*~PSII~ was estimated using FRRf induction curves with excitations (Ex~445nm~, blue, Ex~470nm~, blue-green, Ex~505nm~, green, Ex~535nm~, green-yellow, Ex~590nm~, orange, Ex~590nm~, orange), for PC-rich_077 (light green) and PE-rich_127 (dark red) cultures of *Synechococcus* sp. grown at spectral bandwidth of 405, 445, 470, 535, 620, 660, and 720 nm and O~2~ concentration of 250 µM and 2.5 µM.", .sep = " ")
knitr::include_graphics(file.path(FiguresFP,"Fig_UncalibJVPSII.png"))
```
