...
We estimated the value of the cumulative diel PAR (µmol photons m^−2^d^−1^) using Eq. \@ref(eq:PhotonDoseSine). Cumulative diel PUR was estimated similarly after estimation of peak PUR from peak PAR.
