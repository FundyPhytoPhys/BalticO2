...
Chlorophyll-specific growth rates (µ; d^−1^) show positive linear responses to Phycobiliproteins:Chlorophyll *a* ratio (µg:µg), for both PC-rich and PE-rich *Synechococcus* sp. (Fig. \@ref(fig:Pigment)*b*, Tab. S9), although the relations vary across strain and [O~2~] XXXXNOT PROPER TABLE CITATION - make Sylwia anova for pig ratio!! XXX. 
