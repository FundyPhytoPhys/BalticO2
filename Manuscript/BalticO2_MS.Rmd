...
In oxygenic photoautotrophs, pigment-proteins associated with Photosystem II (PSII) transfer excitation energy to the chlorophyll molecule P680, creating its excited state, P680* [@bennettStructureBasedModelEnergy2013, @croceLightharvestingStructuralOrganization2011]. P680* then transfers the excited electron by reducing a phaeophytin (Phe) intermediate and returns to its oxidized ground state, P680+. The excited electrons are passed from Phe- to QA and then to the bound plastoquinone molecule QB, which migrates to join the mobile plastoquinone (PQ) pool of the thylakoid membrane. Eventually, the electrons are transferred to the Cytochrome b6f complex. The PQ pool can become saturated with electrons [@mackeyEffectTemperaturePhotosynthesis2013] if incoming excitation outpaces downstream electron flow [@falkowskiAquaticPhotosynthesisSecond2013]. The P680+ radical is a strong oxidant and can cause irreversible damage to its surrounding proteins and pigments if it is not quickly reduced [@rappaportKineticsPathwaysCharge2002] by electrons from water within the oxygen-evolving complex of PSII [@falkowskiAquaticPhotosynthesisSecond2013, @rengerLightInducedOxidative2011].
